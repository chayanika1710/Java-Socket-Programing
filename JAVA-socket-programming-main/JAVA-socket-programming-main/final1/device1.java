    ...
    public void run() {
        try {
            ...
            while ((msg = in.readLine()) != null) {
                System.out.println("Device2: " + msg); // Prints messages from Device1
            }
        } catch (IOException e) {
    ...
    public void run() {
        try {
            ...
            while (true) {
                ...
                File file = new File("H:\\final1\\final1_2.0\\" + name + ".txt");
                if (!file.exists()) {
        ...
        try {
            ...
            while (true) {
                ...
                if ("SEND".equals(action)) {
                    ...
                    File file = new File("H:\\final1\\final1_2.0\\" + fileName);
...
public class device1 {
    public static void main(String[] args) {
        ...
        int choice;
        System.out.println("...................I am device1 .............................");

        try {
            // Try to connect as a client
            // socket = new Socket("169.254.191.28", 9806);
            socket = new Socket("localhost",9806);
            System.out.println("Connected to device2 as client.");
        } catch (Exception e) {
            ...
            try {
                ...
                System.out.println("Device2 connected to me as server.");
            } catch (Exception ex) {
